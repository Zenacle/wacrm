    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex gap-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-[500px] w-72 animate-pulse rounded-xl bg-muted/40" />
          ))}
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            >
              <GitBranch className="h-4 w-4 text-[#03B3C3]" />
      ...
      {pipelines.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-20 bg-card">
          <GitBranch className="h-12 w-12 text-muted-foreground/60" />
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-card border-border">
          ...
          <div className="py-2">
            <Label className="text-foreground font-medium">Pipeline Name</Label>
            <Input
          ...
          <DialogFooter className="bg-muted/10 border-border">
            <Button
              variant="outline"
