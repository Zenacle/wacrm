          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              {linkedConversation && (
                <Link
                  href="/inbox"
                  className="mt-1 inline-flex items-center gap-1.5 self-start rounded-md bg-[#03B3C3]/10 px-2 py-1 text-xs text-[#03B3C3] hover:bg-[#03B3C3]/20 transition-colors"
                >
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="0"
                    className="border-border bg-background pl-7 text-foreground placeholder:text-muted-foreground"
                  />
                </div>
              </div>
              <div className="grid gap-2">
                ...
                <select
                  ...
                  className="h-9 w-full rounded-lg border border-border bg-background px-2.5 text-sm text-foreground outline-none focus:border-[#03B3C3]"
                >
            ...
            <div className="grid gap-2">
              <Label className="text-foreground font-medium">Expected Close Date</Label>
              <Input
                type="date"
            ...
            <div className="grid gap-2">
              <Label className="text-foreground font-medium">Stage</Label>
              <select
                value={stageId}
            ...
            {deal &&
              (confirmDelete ? (
                ...
                <button
                  ...
                  className="mt-3 flex w-full items-center justify-center gap-1 text-xs text-red-500 hover:text-red-600 font-medium"
                >
