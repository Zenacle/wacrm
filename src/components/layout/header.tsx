...
export function Header({ onOpenSidebar }: HeaderProps) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-border bg-card px-4 lg:px-6">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          className="flex items-center gap-2 rounded-xl px-1 py-1 transition-colors hover:bg-accent focus:bg-accent focus:outline-none data-popup-open:bg-accent sm:gap-3 sm:pl-1 sm:pr-3"
        ...
        >
          ...
          <DropdownMenuItem
            onClick={signOut}
            className="focus:bg-accent focus:text-accent-foreground cursor-pointer text-destructive focus:text-destructive"
          >
